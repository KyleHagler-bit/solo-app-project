  ...
  <div>
    <center>
      <div className='card' id='aboutContent' style={{ width: '60%' }}>
        ...
        <h3 style={{ width: '80%', margin: 'auto' }}>Journaling has actually been found to help in a multitude of ways! These include but are not limited to:</h3>
        <center>
          <div style={{ margin: '3%', textAlign: 'left', width: '40%' }}>
            <li>Helps in establishing future goals</li>
